...
namespace format_roc2023\output\courseformat;
...
class content extends content_base
{
    ...
    {
        return 'format_roc2023/local/content';
    }
    ...
    public function export_for_template(\renderer_base $output): \stdClass
    {
        ...
        $course->bgcolor = $course->bgcolor != "" ? $course->bgcolor : get_config('format_roc2023', 'bgcolor');
        $course->colorfont = $course->colorfont != "" ? $course->colorfont : get_config('format_roc2023', 'fontcolor');
        $course->bgcolor_selected = $course->bgcolor_selected != "" ? $course->bgcolor_selected : get_config('format_roc2023', 'bgcolor_selected');
        $course->fontcolor_selected = $course->fontcolor_selected != "" ? $course->fontcolor_selected : get_config('format_roc2023', 'fontcolor_selected');;
        ...
        $file_setting = get_config('format_roc2023', 'image_sections');
        if ($file_setting != "") {

            $url_1 = $this->get_content_file('format_roc2023_file', get_config('format_roc2023', 'image_sections'));
    ...
    {
        global $USER;
        $cache = cache::make('format_roc2023', 'user_last_section');
