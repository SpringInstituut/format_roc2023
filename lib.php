 ...
 */
class format_roc2023 extends core_courseformat\base
{
    ...
    public function course_format_options($foreditform = false)
    {
        ...
        $courseformatoptionsedit['colorfont'] = array(
            'label' => get_string('colorfont', 'format_roc2023'),
            'help' => 'colorfont',
            'help_component' => 'format_roc2023',
            'element_type' => 'text',
            'default' => get_config('format_roc2023', 'fontcolor')
        );

        $courseformatoptionsedit['bgcolor'] = array(
            'label' => get_string('bgcolor', 'format_roc2023'),
            'help' => 'bgcolor',
            'help_component' => 'format_roc2023',
            'element_type' => 'text',
            'default' => get_config('format_roc2023', 'bgcolor')
        );

        $courseformatoptionsedit['bgcolor_selected'] = array(
            'label' => get_string('bgcolor_selected', 'format_roc2023'),
            'help' => 'bgcolor',
            'help_component' => 'format_roc2023',
            'element_type' => 'text',
            'default' => get_config('format_roc2023', 'bgcolor_selected')
        );

        $courseformatoptionsedit['fontcolor_selected'] = array(
            'label' => get_string('fontcolor_selected', 'format_roc2023'),
            'help' => 'colorfont',
            'help_component' => 'format_roc2023',
            'element_type' => 'text',
            'default' => get_config('format_roc2023', 'fontcolor_selected')
        );

        $opt = get_config('format_roc2023', 'selectoption');
        $courseformatoptionsedit['selectoption'] = array(
            'label' => get_string('selectoption', 'format_roc2023'),
            'help' => 'selectoption',
            'help_component' => 'format_roc2023',
            'element_type' => 'select',
            'default' => $opt,
        ...
        $courseformatoptionsedit['selectform'] = array(
            'label' => get_string('selectform', 'format_roc2023'),
            'help' => 'selectform',
            'help_component' => 'format_roc2023',
            'element_type' => 'select',
            'default' => 'rounded',
            'element_attributes' => array(
                array(
                    ...
                    'rounded' => get_string('rounded', 'format_roc2023'),
                )
            )
        );

        $courseformatoptionsedit['title_section_view'] = array(
            'label' => get_string('title_section_view', 'format_roc2023'),
        ...
        $courseformatoptionsedit['section_zero_ubication'] = array(
            'label' => get_string('section_zero_ubication', 'format_roc2023'),
        ...
        $max_groups = get_config('format_roc2023', 'max_groups');
        if ($max_groups != 0) {
            ...
            for ($i = 0; $i < $max_groups; $i++) {
                $courseformatoptionsedit['group_sections' . ($i + 1)] = array(
                    'label' => get_string('sections_gruping', 'format_roc2023', $i + 1),
                ...
                $courseformatoptionsedit['group_title' . ($i + 1)] = array(
                    'label' => get_string('title_gruping', 'format_roc2023', $i + 1),
                    'help' => 'title_gruping',
                    'help_component' => 'format_roc2023',
                    'element_type' => 'text',
                );
                ...
                $courseformatoptionsedit['group_colorfont' . ($i + 1)] = array(
                    'label' => get_string('color_gruping', 'format_roc2023', $i + 1),
                    'help' => 'colorfont',
                    'help_component' => 'format_roc2023',
                    'element_type' => 'text',
                );
